...
check: fmt lint py-lint
	...
	$(PYTHON) -m py_compile python/hf_pricing.py python/cost_ledger.py python/upload_checkpoints.py python/param_name_map.py python/convert_reference.py python/verify_conversion.py scripts/launch_hf_job.py scripts/check_release_blockers.py scripts/check_phase_a_handoff.py scripts/upload_model_cards.py scripts/check_warmstart_source.py scripts/full_pusht_contract_smoke.py scripts/check_full_pusht_contract_smoke_report.py scripts/f1_export_pusht_onnx.py scripts/pusht_warmstart_source_smoke.py scripts/check_pusht_warmstart_source_smoke_report.py scripts/audit_pusht_warmstart_sources.py scripts/check_pusht_warmstart_hub_audit_report.py
