...
check: fmt lint py-lint
	...
	$(PYTHON) -m py_compile python/hf_pricing.py python/cost_ledger.py python/upload_checkpoints.py python/param_name_map.py python/convert_reference.py python/verify_conversion.py scripts/launch_hf_job.py scripts/check_release_blockers.py scripts/upload_model_cards.py
