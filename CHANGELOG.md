...
- Docker / HF Jobs reproduction docs now match the checked-in Dockerfile and
  ...
  release-facing surfaces against reintroducing stale full-checkpoint claims,
  ambiguous paper wording around the historical 50k-step bounded-core run, or
  stale SO-100 warm-start source-path claims.
