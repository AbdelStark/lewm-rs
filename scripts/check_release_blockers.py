...
REQUIRED_RESOLUTION_SUBSTRINGS_BY_ID: dict[str, tuple[str, ...]] = {
    ...
    "F2": (
        ...
        "F1 full-training ONNX artifacts",
        "reports/pusht_eval.md",
        "success rate",
        "p50/p95 latency",
        "F4 and F7",
    ),
    "F3": (
        "compatible current bounded-core PushT .mpk source checkpoint",
    ...
    "F4": (
        ...
        "ONNX artifact links",
        "CHANGELOG.md",
        "README.md and paper/lewm-rs.md",
    ),
    "F5": (
        "from-scratch vs warm-start training comparison",
        "reports/so100_warmstart.md",
        "Spearman correlation delta",
        "warm-start loss delta",
        "CHANGELOG.md",
        "README.md and paper/lewm-rs.md",
    ),
    "F6": (
        "https://huggingface.co/spaces/abdelstark/lewm-rs-demo",
        "one CEM planning demo episode",
        "F1 full-training ONNX artifacts",
        "F2 success-rate result",
    ),
    "F7": (
        "paper section 6.2",
        "PushT success rate",
        "CEM latency",
        "reports/pusht_eval.md",
        "paper/figures/pusht_eval.pdf",
    ),
    "F8": (
        "paper section 7.3",
        "warm-start Spearman delta",
        "warm-start loss delta",
        "paper/figures/so100_warmstart.pdf",
    ),
    "F9": (
        "HF Hub blog post",
        "live URL",
        "finalized PushT and SO-100 model cards",
        "demo Space",
        "CHANGELOG.md",
    ),
    "F10": (
        ...
        "F7 and F8",
        "arXiv",
        "README.md, CITATION.cff, and CHANGELOG.md",
    ),
    "F11": (
    ...
    "F13": (
        "Resolve F1 through F12",
        "CARGO_INCREMENTAL=0 make accept",
        "dated 1.0.0 release section",
        "signed v1.0.0 tag",
        "release.yml and the GitHub Release artifacts",
    ),
}
